$(window).scroll(function () {
  ...
  require.config({
    paths: { vs: "https://unpkg.com/monaco-editor@0.17.0/min/vs" }
  });
  ...
  */
  ...
  require(["vs/editor/editor.main"], () => {
    monaco.editor.onDidCreateEditor(onCreated);
    monaco.editor.create(
      document.getElementById("angular-editor"),
      Object.assign(options, angular)
    );
  });
  ...
  require(["vs/editor/editor.main"], () => {
    monaco.editor.onDidCreateEditor(onCreated);
    monaco.editor.create(
      document.getElementById("node-editor"),
  ...
  require(["vs/editor/editor.main"], () => {
    monaco.editor.onDidCreateEditor(onCreated);
    monaco.editor.create(
      document.getElementById("php-editor"),
      Object.assign(options, php)
    );
  });
